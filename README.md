...
## [1.4.1] June 1, 2026
### Added
- Full JSON Schema dialect support for 2019-09, and 2020-12 across form rendering, schema editing, and validation (resolves [#4](https://github.com/plasma-mds/adamant/issues/4); 2020-12 included as additional dialect beyond the original issue scope).
